OC.L10N.register(
    ...
    "Template repo admin delegation" : "群組資料夾委派管理員",
    "They will have access to all Templaterepos." : "他們可以存取所有的群組資料夾。",
    "They will only have access to template repos for which they have advanced permissions." : "他們僅能存取他們擁有進階權限的群組資料夾。",
    "Folder name" : "範本資料夾",
    "Groups" : "可瀏覽的群組",
    "Quota" : "容量限額",
    "Advanced Permissions" : "進階權限",
    "They will only have access to Templaterepos for which they have advanced permissions." : "他們僅能存取他們擁有進階權限的群組資料夾。",
